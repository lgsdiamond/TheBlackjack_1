 ...
 * [StrategyFrag.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [StrategyFrag.newInstance] factory method to
 * create an instance of this fragment.
 */
class StrategyFrag : BjFragment() {
    ...
    companion object {
        ...
        fun newInstance(barTitle: String): StrategyFrag {
            val fragment = StrategyFrag()
            val args = Bundle()
