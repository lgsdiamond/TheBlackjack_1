 ...
 * [CountingFrag.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [CountingFrag.newInstance] factory method to
 * create an instance of this fragment.
 */
class CountingFrag : BjFragment() {
    ...
    companion object {
        ...
        fun newInstance(barTitle: String): CountingFrag {
            val fragment = CountingFrag()
            val args = Bundle()
