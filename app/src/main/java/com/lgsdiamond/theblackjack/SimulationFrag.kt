 ...
 * [SimulationFrag.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [SimulationFrag.newInstance] factory method to
 * create an instance of this fragment.
 */
class SimulationFrag : BjFragment() {
    ...
    companion object {
        ...
        fun newInstance(barTitle: String): SimulationFrag {
            val fragment = SimulationFrag()
            val args = Bundle()
