 ...
 * [LearningFrag.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [LearningFrag.newInstance] factory method to
 * create an instance of this fragment.
 */
class LearningFrag : BjFragment() {
    ...
    companion object {
        ...
        fun newInstance(barTitle: String): LearningFrag {
            val fragment = LearningFrag()
            val args = Bundle()
