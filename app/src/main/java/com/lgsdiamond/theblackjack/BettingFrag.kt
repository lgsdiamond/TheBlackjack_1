 ...
 * [BettingFrag.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [BettingFrag.newInstance] factory method to
 * create an instance of this fragment.
 */
class BettingFrag : BjFragment() {
    ...
    companion object {
        ...
        fun newInstance(barTitle: String): BettingFrag {
            val fragment = BettingFrag()
            val args = Bundle()
